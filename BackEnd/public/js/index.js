...
class LatestEvents {
   ...
   * @param {JSON} data - JSON Object of Latest Events containing image, title, date, and desc.
   * @param {String} target - Id of the target element.
  ...
  constructor(data = null, target = "LE-List", sliderTarget = "LE-dot-slider") {
    if (data === null) {
      this.data = [
        {
          image: "Assets/Events/LE10.jpg",
          title: "",
          date: "10/10/2021",
          desc: "",
        },
        {
          image: "Assets/Events/LE04.jpg",
          title: "",
          date: "10/10/2021",
          desc: "",
        },
        {
          image: "Assets/Events/LE07.jpg",
          title: "",
          date: "10/10/2021",
          desc: "",
        },
        {
          image: "Assets/Events/LE14.jpg",
          title: "",
          date: "10/10/2021",
          desc: "",
        },
        {
          image: "Assets/Events/LE15.jpg",
          title: "",
          date: "16/12/2023",
          desc: "",
        },
        {
          image: "Assets/Events/LE16.jpg",
          title: "",
          date: "16/12/2023",
          desc: "",
        },
        {
          image: "Assets/Events/LE05.jpg",
          title: "",
          date: "10/10/2021",
          desc: "",
        },
        {
          image: "Assets/Events/LE11.jpg",
          title: "",
          date: "10/10/2021",
          desc: "",
        },
        {
          image: "Assets/Events/LE03.jpg",
          title: "",
          date: "10/10/2021",
          desc: "",
        },
        {
          image: "Assets/Events/LE01.jpg",
          title: "",
          date: "10/10/2021",
          desc: "",
        },
        {
          image: "Assets/Events/LE09.jpg",
          title: "",
          date: "10/10/2021",
          desc: "",
        },
        {
          image: "Assets/Events/LE06.jpg",
          name: "",
          date: "10/10/2021",
          desc: "",
        },
        {
          image: "Assets/Events/LE08.jpg",
          name: "",
          date: "10/10/2021",
          desc: "",
        },
        {
          image: "Assets/Events/LE12.jpg",
          name: "",
          date: "10/10/2021",
          desc: "",
        },
        {
          image: "Assets/Events/LE13.jpg",
          name: "",
          date: "10/10/2021",
          desc: "",
        },
   ...
   * @param {JSON} elem - JSON Object of Latest Events containing image, count, name, date and desc.
   * @returns {void}
   * @example
   * let LE = new LatestEvents();
   * LE.addAchievement({
   *   image: "https://nsutiif.in/image/gallery/2.jpeg",
   *   name: "Startup Incubated",
   *   date: "10/10/2021",
...
class SuccessStories {
   ...
   * @param {JSON} data - JSON Object of Success Stories containing img, name, and desc.
   * @param {String} target - Id of the target element.
   * @returns {void}
   * @example
   ...
   * @param {JSON} elem - JSON Object of Success Stories containing img, name, and desc.
...
$(document).ready(function () {
  ...
  let LE = new LatestEvents(data=latestEvents);
...
const showHideIcons = () => {
  ...
  arrowIcons[1].style.display =
    scrollLeft >= scrollWidth - threshold ? "none" : "block";
};
...
const showPopup = (item,name) => {
  
  localStorage.setItem(
    name,
    JSON.stringify({ id: item._id, date: new Date().getTime() })
  );
  Swal.fire({
    html : `<a href="/apply?open=${item?.form}" target="_blank"><div><img src="${item?.image}" style="width:100%;min-height:400px;object-fit:cover;"/> <span class="mt-3 btn btn-primary"> Learn More</span></div></a>`,
    timer: 5000,
...
if (popup) {
  if (localStorage.getItem("popup")) {
    let pop = JSON.parse(localStorage.getItem("popup"));
    if (popup._id === pop.id) {
      let date = new Date().getTime();
      if (date - pop.date > 3600000) {
...
window.onload = function() {
  ...
  for(const carousel of document.querySelectorAll('#event .carousel')) {
      const csl = new Carousel(carousel.querySelector('#event .carousel-wrapper'), carousel.querySelectorAll('.carousel-slide'));
